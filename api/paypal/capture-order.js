import { assertPaymentEnabled, captureMatchesOrder, getSupabaseAdmin, paypalRequest, sendJson } from "./_paypal.js";
export default async function handler(request, response) {
  ...
  try {
    ...
    if (order.payment_status === "paid") return sendJson(response, 200, { ok: true, alreadyCaptured: true });
