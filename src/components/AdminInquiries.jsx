...
const requestProductSummaryStyle = orderPositionCardStyle;
const requestProductHeaderStyle = orderPositionHeaderStyle;
const requestSummaryMetaStyle = orderPositionMetaStyle;
const requestChipStyle = orderPositionChipStyle;
const requestPriceSummaryStyle = orderPositionPriceStyle;
const requestExtrasListStyle = orderPositionExtrasStyle;
const requestExtraRowStyle = orderPositionExtraStyle;
